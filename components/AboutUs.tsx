      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16 items-center">
            <div className="bg-blue-600 text-white p-8 rounded-lg shadow-xl">
                ...
                <p className="text-blue-200 text-lg">To empower organizations with actionable insight that turns complexity into opportunity.</p>
            </div>
            <div className="bg-slate-700 text-white p-8 rounded-lg shadow-xl">
                <h3 className="text-3xl font-bold mb-3">Vision</h3>
                <p className="text-slate-300 text-lg">To be the preferred consulting partner recognized for clarity, integrity, and impact across Africa and beyond.</p>
            </div>
        </div>
