        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8 text-center md:text-left">
          ...
          <div>
            ...
            <ul className="space-y-2">
                ...
                <li><FooterLink href="#cases">Case Studies</FooterLink></li>
          ...
          <div>
            ...
            <p className="text-slate-400 mb-4">info@csinsight.com</p>
            <div className="flex justify-center md:justify-start space-x-5">
              ...
              <SocialIcon href="#"><YouTubeIcon className="w-6 h-6" /></SocialIcon>
            </div>
          </div>
        </div>
